...
import ch.post.logistics.mailpiece.processor.service.MailpieceGeneratorService
...
class MailpieceGeneratorController(val mailpieceGeneratorService: MailpieceGeneratorService) {
    ...
    fun generate(
        ...
        return mailpieceGeneratorService.generate(nr, from, delay).map { event -> toString(event) }
    }
